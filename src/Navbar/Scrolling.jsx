    ...
    : "relative"
        ...
        <div className="-ml-8">
            <div className="flex justify-between lg:justify-evenly">
              <p className="m-5 p-2 px-4 text-2xl font-semibold text-white"><span className="text-yellow-300">M</span>yPropAi</p>
              <div className="flex justify-center hidden lg:flex">
                  <div className="mt-6 bg-white flex ml-4 mb-4 rounded-full items-center p-2 md:p-1 lg:py-2 lg:px-6 
                    shadow-lg">
              ...
              <button className="m-5 p-2 hidden lg:block px-4 bg-yellow-400 px-6 hover:cursor-pointer
               py-2 rounded-full font-semibold text-sm ">Post Property Free</button>
               <button className="hidden lg:block text-white border-2 border-amber-500 rounded-full m-5  p-2 px-4 hover:cursor-pointer">
                    Sign In/Sign up
                </button> 
                <div className="flex flex-row gap-0 text-white m-5 p-2 px-4">
                  <p className="text-2xl hover:cursor-pointer">Menu</p>
                  <CiMenuFries  className="text-white mt-1 text-3xl hover:cursor-pointer"/>
                </div>
